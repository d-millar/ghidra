 ...
 */
public class LldbReadPhysicalMemoryCommand extends AbstractLldbCommand<RangeSet<Long>> {
	...
	public LldbReadPhysicalMemoryCommand(LldbManagerImpl manager, long addr, ByteBuffer buf,
			int len) {
		super(manager);
		this.addr = addr;
		this.buf = buf;
