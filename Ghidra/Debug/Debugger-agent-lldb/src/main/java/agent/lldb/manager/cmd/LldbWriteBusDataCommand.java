 ...
 */
public class LldbWriteBusDataCommand extends AbstractLldbCommand<Void> {
	...
	public LldbWriteBusDataCommand(LldbManagerImpl manager, long addr, ByteBuffer buf, int len,
