 ...
 */
public class LldbReadDebuggerDataCommand extends AbstractLldbCommand<RangeSet<Long>> {
	...
	public LldbReadDebuggerDataCommand(LldbManagerImpl manager, long addr, ByteBuffer buf, int len) {
		super(manager);
		this.addr = addr;
		this.buf = buf;
		this.len = len;
