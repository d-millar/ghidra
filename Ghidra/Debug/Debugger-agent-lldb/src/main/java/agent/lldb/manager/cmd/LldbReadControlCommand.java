 ...
 */
public class LldbReadControlCommand extends AbstractLldbCommand<RangeSet<Long>> {
	...
	public LldbReadControlCommand(LldbManagerImpl manager, long addr, ByteBuffer buf, int len,
			int processor) {
		super(manager);
		this.addr = addr;
		this.buf = buf;
