...
public class LldbDebuggerProgramLaunchOpinion implements DebuggerProgramLaunchOpinion {
	...
	protected class SshLldbDebuggerProgramLaunchOffer extends AbstractLldbDebuggerProgramLaunchOffer {
		private static final String FACTORY_CLS_NAME = "agent.Lldb.LldbOverSshDebuggerModelFactory";

		public SshLldbDebuggerProgramLaunchOffer(Program program, PluginTool tool,
				DebuggerModelFactory factory) {
			super(program, tool, factory);
		}
		...
		public String getQuickTitle() {
			...
			return String.format("in LLDB via ssh:%s@%s",
	...
	public Collection<DebuggerProgramLaunchOffer> getOffers(Program program, PluginTool tool,
		...
		for (DebuggerModelFactory factory : service.getModelFactories()) {
			...
			else if (clsName.equals(SshLldbDebuggerProgramLaunchOffer.FACTORY_CLS_NAME)) {
				offers.add(new SshLldbDebuggerProgramLaunchOffer(program, tool, factory));
			}
		}
		return offers;
	}
